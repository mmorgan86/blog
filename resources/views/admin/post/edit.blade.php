                        ...
                        <form role="form" action="{{ route('post.update', $post->id) }}"
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="title"
                                               name='title' placeholder="Enter Title" value="{{$post->title}}">
                                    </div>

                                    <div class="form-group">
                                        <label for="subtitle">Post Subtitle</label>
                                        <input type="text" class="form-control" name="subtitle" id="subtitle"
                                               placeholder="Enter Subtitles" value="{{$post->subtitle}}">
                                    </div>
                            ...
                            <div class="box">
                                ...
                                <div class="box-body pad">
                                    <textarea name='body' id='editor1' placeholder="Speak your mind
                                    here..."
